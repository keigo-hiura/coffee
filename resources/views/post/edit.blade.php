        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="name" name="name" value="{{ $post_edit->name }}"  placeholder="コーヒー名を記入してください！" class="w-full rounded">
                </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <textarea id="content" name="content" class="w-full py-16 rounded" placeholder="内容を記入してください！">{{ $post_edit->content }}</textarea>
                </div>
                </div>
                <div class="p-2 w-full">
